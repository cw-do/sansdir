...
console script and runs it as a subprocess; it does not reimplement, vendor, or
wrap the physics. Two deployment realities are absorbed on the caller's side.
