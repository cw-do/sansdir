...
\begin{table}[ht]
  ...
  \begin{tabular}{l p{0.68\textwidth}}
    ...
    \texttt{usans/} & \texttt{grouping.py} (title blocks), \texttt{reconcile.py}
      ...
      external engine). Pure; imports no interface or network module. \\
...
same editor. What it adds is a short reduction workflow. Rather than ship a
second application, the program carries an \emph{instrument mode} and a small,
